...
2. 在 [学习状态](templates/learning-state.md) 中写下当前基线：已经知道什么、还不会什么、什么结果算完成。
...
[使用 AI 学习一切](threads/part-3/1-ai-learning.md)不从“哪个模型最好”开始，而从“我要解决什么问题”开始。AI 可以循序提问、解释概念、比较方案、整理材料和生成练习；人需要确定目标、选择可信来源、识别幻觉，并在关闭对话之后独立解释和使用所学。
...
从 [CEFR 目标与自测](threads/part-1/0-cefr.md)建立真实基线，再按需要进入 [认知](threads/part-1/1-understanding.md)、[词汇](threads/part-1/2-vocabulary.md)、[听力](threads/part-1/3-listening.md)、[阅读](threads/part-1/4-reading.md)、[口语](threads/part-1/5-speaking.md)、[写作](threads/part-1/6-writing.md)和[用 AI 学英语](threads/part-1/7-ai.md)。也可以直接使用 [英语能力诊断](templates/english-diagnostic.md)，为下一轮学习找到起点。

英语水平不由收藏的单词量证明，而由你能否在真实场景中理解、表达和完成任务证明。它是一座桥，不是一堵用来评价自己的墙。

## 人生复盘与恢复：经验也需要重新解释

[我的故事](threads/part-2/my-story.md)、[创业篇](threads/part-2/entrepreneurship.md)和[旧文归档](threads/archive/README.md)保留了失败、身体失序、关系变化、离开与重返。回望不是为了把过去装饰成励志故事，而是为了辨认：哪些决定有效，哪些代价不能忽略，下一次怎样活得更诚实。
...
<div class="latest-updates">
  <figure class="latest-update">
    <img src="./assets/latest/single-again.jpg" alt="韩先凯与伴侣的合影" />
    <figcaption><strong>重新相信相遇</strong>经历关系结束、恢复与重新整理生活之后，韩先凯开启了一段新的恋情。重新开始不会抹去过去，但它证明生活仍然能够向前生长。</figcaption>
  </figure>
  <figure class="latest-update">
    <img class="latest-update-fan-photo" src="./assets/latest/agentic-db-fans.jpg" alt="韩先凯在 Agentic DB 大会与读者合影" />
